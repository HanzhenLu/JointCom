...
valid_dataset = TextDataset(tokenizer, valid_file_name)
...
train_output = open(os.path.join(output_path, 'train.jsonl'), 'w')
...
valid_output = open(os.path.join(output_path, 'valid.jsonl'), 'w')
