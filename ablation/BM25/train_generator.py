...
class Example(object):
    ...
    def __init__(self,
        ...
        self.idx = idx
        self.source = source.replace('</s>', '<unk>')
        self.target = target.replace('</s>', '<unk>')
        self.similar_code = similar_code.replace('</s>', '<unk>')
        self.similar_comment = similar_comment.replace('</s>', '<unk>')
